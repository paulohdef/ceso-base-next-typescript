...
export const List = () => {
  const items = [
    ...
    },
    {
      ...
      progress: 55,
      color: 'bg-red-500',
      img: '/images/conducaoveicular.png',
      timeago: '3 days ago',
    },
    {
      title: 'Auxilio Juridico',
      sentence: 'Odit omnis enim sapiente labore.',
      description:
        'Et qui ut voluptatem debitis assumenda dolore velit quo vero.',
      number: 7,
